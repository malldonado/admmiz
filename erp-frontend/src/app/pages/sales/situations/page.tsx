...
import Button from '@/components/panel/sales/situations/button';
import Table from '@/components/panel/sales/situations/table';

const SalesSituations: React.FC = () => {
  return (
...
export default SalesSituations;