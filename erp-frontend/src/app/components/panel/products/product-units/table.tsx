...
const TableRow: FC<User> = ({ name, acronym, template }) => (
  <tr>
    <td className="px-4 py-4 text-sm text-black whitespace-nowrap">{name}</td>
    <td className="px-4 py-4 text-sm text-black whitespace-nowrap">{acronym}</td>
    <td className="px-4 py-4 text-sm text-black whitespace-nowrap">{template}</td>
    <td className="px-4 py-4 text-sm text-black whitespace-nowrap flex justify-end items-center">
      <NextLink href="/pages/customers/product-units/edit">
        <FiEdit
