            ...
            <form action="#" method="POST" className="mt-8">
              <div className="space-y-5">
                ...
                <Link href="/pages/dashboard">
                  <button
                    type="submit"
                    className="inline-flex items-center justify-center w-full px-4 py-4 text-base font-semibold text-white transition-all duration-200 border border-transparent rounded-md bg-gradient-to-r bg-[#0b1e40] focus:outline-none hover:opacity-80 focus:opacity-80"
                  >
                    Sign up
                  </button>
                </Link>
