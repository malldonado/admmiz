...
import Button from '@/components/panel/budgets/services/button';
import Input from '@/components/panel/budgets/services/input';
import Table from '@/components/panel/budgets/services/table';

const BudgetsServices: React.FC = () => {
  return (
