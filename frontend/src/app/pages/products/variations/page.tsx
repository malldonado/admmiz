...
import Button from '@/components/panel/products/variations/button';
import Input from '@/components/panel/products/variations/input';
import Table from '@/components/panel/products/variations/table';

const ProductsVariations: React.FC = () => {
  return (
